<#assign active="setting" title="系统设置" site_url=options.site_url >
<#include "header.ftl" >
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" id="global-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="social_weibo" placeholder="微博"
                                   value="${(options.social_weibo)!}" required aria-required="true"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-3 control-label">知乎</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="social_zhihu" placeholder="知乎"
                                   value="${(options.social_zhihu)!}" required aria-required="true"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="social_github" placeholder="Github"
                                   value="${(options.social_github)!}" required aria-required="true"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="social_twitter" placeholder="Twitter"
                                   value="${(options.social_twitter)!}" required aria-required="true"/>
                        </div>
                    </div>
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" id="advanced-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea rows="3" class="form-control" name="block_ips"
                                      placeholder="请输入黑名单IP，如：123.123.33.23,123.123.33.24">${(options.site_block_ips)!''}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="toggle toggle-success allow-${(options.allow_install)!0}"
...
<#include "./footer.ftl" >
<@com.resource_loader type="toggles" />
<script type="text/javascript">
    ...
    function saveSetting() {
        ...
        tale.post({
            url : '${request.contextPath}/admin/setting',
            data: param,
    ...
    function saveAdvanced() {
        ...
        tale.post({
            url: '${request.contextPath}/admin/advanced',
            data: param,
            success: function (result) {
                if (result && result.success) {
                    tale.alertOk('选项保存成功');
    ...
    function backup(type) {
        ...
        tale.post({
            url : '${request.contextPath}/admin/backup',
            data: param,
            success: function (result) {
                if(result && result.success){
