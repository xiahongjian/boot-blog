<#assign active="attach" title="文件管理" >
<#include "header.ftl" >
<@com.resource_loader type="attach_head" />
<style>
    #dropzone {
        margin-bottom: 3rem;
    }
...
<div class="row">
    ...
    <div class="col-md-12 attach">
        <#if !(attaches??) || attaches.list?size == 0>
        <div class="row">
        ...
        <@com.pageAdminNav pageInfo=attaches />
        </#if>
    </div>
</div>
...
<@com.resource_loader type = "attach_foot" />
...
<script type="text/javascript">
    ...
    $("#dropzone").dropzone({
        url: "${request.contextPath}/admin/attach/upload",
    ...
    function delAttach(id) {
        tale.alertConfirm({
            ...
            then: function () {
                tale.post({
                    url: '${request.contextPath}/admin/attach/delete',
                    data: {id: id},
