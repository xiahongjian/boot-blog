...
public class LogController extends BaseController {
    ...
    public String index(Model model,
        ...
        bizLogs.setPageNum(logs.getPageNum());
        bizLogs.setPageSize(logs.getPageSize());
        bizLogs.setSize(logs.getSize());
        bizLogs.setStartRow(logs.getStartRow());
        bizLogs.setEndRow(logs.getEndRow());
        bizLogs.setPages(logs.getPages());
        bizLogs.setPrePage(logs.getPrePage());
        bizLogs.setNextPage(logs.getNextPage());
        bizLogs.setIsFirstPage(logs.isIsFirstPage());
        bizLogs.setIsLastPage(logs.isIsLastPage());
        bizLogs.setHasPreviousPage(logs.isHasPreviousPage());
        bizLogs.setHasNextPage(logs.isHasNextPage());
        bizLogs.setNavigateFirstPage(logs.getNavigateFirstPage());
        bizLogs.setNavigatepageNums(logs.getNavigatepageNums());
        bizLogs.setNavigateFirstPage(logs.getNavigateFirstPage());
        bizLogs.setNavigateLastPage(logs.getNavigateLastPage());
